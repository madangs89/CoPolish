    ...
    <div className="min-h-screen w-full bg-[#fafafa] px-4 md:px-8 py-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-[#6b6b6b] mt-2 max-w-2xl">
          AI analyzed your resume and LinkedIn profile. Fix key gaps to
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
        ...
        <ProfileCard
          title="Resume"
          icon={<FileUser className="w-5 h-5 text-[#025149]" />}
          action={() => navigate("/editor/resume/1324")}
          actionLabel="View full resume"
        >
          <ProfilePreview
            title="Summary"
            content="MERN Stack developer building scalable web & AI-powered tools."
          />

          <ProfileList
            title="Experience"
            items={[
              "Built full-stack apps using React & Node.js",
              "Integrated AI resume parsing workflows",
            ]}
          />

          <ProfilePreview
            title="Skills"
            content="JavaScript, React, Node.js, MongoDB, Tailwind"
          />
        </ProfileCard>
      ...
      <div className="rounded-2xl border border-[#e6e6e6] bg-white p-6">
        ...
        <ul className="space-y-3 text-sm">
          ...
          <ActivityItem label="LinkedIn post draft generated" time="2 days ago" />
        </ul>
      </div>
    </div>
  );
  ...
  return (
    <div className="rounded-2xl border border-[#e6e6e6] bg-white p-6">
      ...
      <div className="flex items-end gap-2 mb-1">
        <span className="text-3xl font-semibold text-[#1f2430]">
          {score}
        </span>
